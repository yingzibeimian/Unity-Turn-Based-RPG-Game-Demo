...
{
    CreateNewMagicItemData createNewMagicItemData; //创建面板数据
    ...
    {
        GetWindow<MagicItemDataEditor>().Show(); //创建并显示编辑器窗口
    }
    ...
    protected override void OnDestroy()
    {
        ...
        {
            DestroyImmediate(createNewMagicItemData.magicItemData); //清理未保存的临时数据
        }
    }
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        tree.AddAllAssetsAtPath("MagicItem Data", "Assets/Data/ScriptableObjects/Item/ItemMagic/Instances", typeof(MagicItemData)); //AddAllAssetsAtPath扫描指定路径下的指定类型资源
